...
No target value from a test sample reaches training; the retention rule
decides membership only, and that should be stated when the metrics are quoted.
"""
...
def _write_split_manifest(
    ...
    them makes the partition checkable without re-running the split, and
