...
class SplitConfig:
    ...
    #: memberships were recovered from the deposited Fig. 3 prediction records.
...
@dataclass
class GANConfig:
    """WGAN-GP generation and filtering.
    ...
    surviving GAN_v2.ipynb, the Methods description of augmentation, and the
...
class SurrogateConfig:
    """DNN hyperparameter search and ensemble construction.
...
class SelectionConfig:
    """Candidate enumeration and Pareto-based selection."""
