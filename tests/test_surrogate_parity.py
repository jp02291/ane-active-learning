...
def test_scalers_are_fit_on_measured_data_only(scenario):
    """The claim made in Methods, checked rather than asserted.
...
# ===========================================================================
# hyperparameter search, against DNN_GAN.ipynb
# ===========================================================================
...
def test_fold_scalers_see_only_the_fold_training_rows():
    """The Methods claim, at the fold level rather than the run level."""
