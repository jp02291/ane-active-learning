...
projection, the Fig. 5(d) disorder parameters, and the two comparisons under
...
analysis/    the published figures that are not produced by a pipeline stage.
             ...
             a cycle.
├── pca/          Fig. 3(d), the biplot of the 30 nominated compositions
├── bootstrap/    Fig. 2, the paired percentile bootstrap of the two branches
...
├── fig5/         Fig. 5(d) disorder parameters and the Fig. 5 source data
└── audit_results/  machine-readable outputs of the pre-submission audit
```
